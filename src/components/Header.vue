<template>
  <header>
    <div class="border-b py-3 hidden sm:block">
      <div class="container mx-auto px-5 flex items-center justify-between">
        <div class="flex items-center gap-7 text-sm [&>*]:cursor-pointer">
          <a class="flex items-center gap-2">
            ...
            <p class="font-medium text-[#454545]">2nd Floor New World.</p>
          </a>
          <a class="flex items-center gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="font-medium text-[#454545]">+498556778345</p>
          </a>
          <a class="flex items-center gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              height="13"
              fill="currentColor"
              class="text-primary bi bi-envelope-fill"
              viewBox="0 0 16 16"
            >
              <path
            ...
            <p class="font-medium text-[#454545]">demo@example.com</p>
          </a>
        </div>
    ...
    <div class="border-b py-3 md:hidden">
      <a>
        <img alt="logo" src="../assets/img/logo.png" class="w-24 mx-auto" />
      </a>
    </div>
